...
influencer-quote-list:
    ...
    - excerpt: "User Needs Mapping is a vital approach for any leader who wants to empower teams to be good stewards of meaningful outcomes. I am confident it will help you and your teams deliver value with less friction and more meaning."  
      image_path: "/assets/images/profiles/matthew_skelton.jpg"
      image_caption: "Matthew Skelton, Co-author, Team Topologies"
practitioner-quote-list:
...
next-step-list:
  ...
  - alt: "The book"
    ...
    excerpt: "User Needs Mapping — your field guide to seeing and shaping alignment."
...
{% include section-image-right-two-col.html
    section_class="section--no-padding"
    title="User Needs Mapping helps you see what’s really happening beneath the surface."
...
{% include call-to-action-two-col.html
    intro_text="User Needs Mapping – Aligning Teams Around What Matters shows you how to break that cycle. Through real examples, step-by-step guidance, and visual tools, you’ll learn how to make user needs visible, clarify responsibilities, and evolve team interactions for fast, sustainable flow of value.  
...
{% include quote_row.html id="influencer-quote-list" title="Endorsed by leaders shaping how we work" section_wrap=true %}

{% include quote_row.html id="practitioner-quote-list" title="What practitioners are saying" section_wrap=true section_class="section--cyan" %}

{% include quote_row.html id="impact-quote-list" title="Real impact in real organisations" section_wrap=true section_class="section--grey" %}
...
{% include section.html
    ...
    section_class="section--orange section--no-padding-bottom"
%}
...
{% include section-image-left-two-col.html
    title="Rich Allen"
    section_class="section--no-padding-bottom section--meet-the-author"
